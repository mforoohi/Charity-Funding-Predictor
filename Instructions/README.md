...
all the other numerical values considerd as features(after conveting all the categorical to numerical1-)
...
5. Train with additional epochs, however, the convergence does not change too much after 100 iterations. 
 If I were to implement a different model to solve this classification problem, which would you choose? Why?
